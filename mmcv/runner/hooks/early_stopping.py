...
class EarlyStoppingHook(Hook):
    ...
    def __init__(self,
        ...
        self.average_loss = AverageLoss(name='validation loss', n=smoothing_window_size)
    ...
    def after_val_iter(self, runner):
        ...
        self.average_loss.update(runner.log_buffer.output[self.monitor])
        avg_loss = self.average_loss.average()
        runner.log_buffer.output['smoothed_val_loss'] = avg_loss

        self._run_early_stopping_check(runner, avg_loss)
    ...
    def _run_early_stopping_check(self, runner, current:float):
